...
\033[1;96m  ____    __   ____  __  __  __   
\033[1;96m (  _ \  /__\ (_  _)(  )(  )(  )   \033[1;96mRatul Hasan
\033[1;94m )   / /(__)\  )(   )(__)(  )(__ 
\033[1;95m (_)\_)(__)(__)(__) (______)(____)



\033[1;93m➤\033[1;97m Author     : Ratul
\033[1;93m➤\033[1;97m Github     : https://github.com/CodingRatul
\033[1;93m➤\033[1;97m Facebook  : https://www.facebook.com/Mr.R4tul
...
def main():
    ...
    print("\033[0;93m[ Starting Main Menu ]").center(50)

    print("")

    print("\033[1;97m[ 1 ]\033[1;91m > \033[1;92mClone Public ID With b-api")
    print("\033[1;97m[ 2 ]\033[1;91m > \033[1;92mTOOL UPDATE ")
...
def main_select():
    ...
    if IKB =="2":
        ...
        os.system("xdg-open https://www.facebook.com/junide.hossin.92 ")
...
def login():
    ...
    print("\033[1;97m[ 2 ]\033[1;91m > \033[1;97mLogin using email & Password")
...
def login_select():
	...
	print("")
        ...
        try:
            ...
            print("\033[1;92mToken login Successfully && you will Redirect to Our Group").center(50)
          
           
           
           
           
	    os.system("xdg-open https://facebook.com/groups/196310582274445/ ")
...
def menu():
    ...
    print("\t\033[1;92mASSALAMUALiKUM : " +nm)
...
def menu_select():
	...
	if select =="2":
		...
		try:
		    ...
		    print("\033[1;91m Logged id has checkpoint").center(50)
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;96m[Ratul] "+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;96m] "+uid+" [Ratul] | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;96m[Ratul] "+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;96m[Ratul] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;96m[Ratul] "+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;96m[Ratul] "+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;96m[Ratul] "+uid+" | "+pass7+"\x1b[1;0m")
	...
	print ("[ ! ] Total Ratul-cp/ARFINA : "+str(len(cps)) + "/"+str(len(oks)))
